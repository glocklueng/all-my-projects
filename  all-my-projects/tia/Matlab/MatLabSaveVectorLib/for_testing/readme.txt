...
-MatLabSaveVectorLib.dll
   -contains the generated component using MWArray API. 
-MatLabSaveVectorLibNative.dll
...
MatLabSaveVectorLib_overview.html - HTML overview documentation file for the generated 
...
MatLabSaveVectorLib.xml - This file contains the code comments for the 
                                    MatLabSaveVectorLib component classes and methods. 
                                    Using a third party documentation tool, this file can 
                                    be combined with either or both of the previous files 
                                    to generate online documentation for the 
                                    MatLabSaveVectorLib component.
