...
//
		...
		case CALC_PRES_STEP:
			...
			Shift_128bits_right(&ui128,21); // сдвигаем получившиеся 128 битное число
			i64=ui128.l; // теперь искомый результат не превышает 64 бит и располагается в младщей части
