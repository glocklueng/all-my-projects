...
void i2cMgr_t::Init() {
    // ==== Init I2C ====
    // Init clock
    RCC_APB1PeriphClockCmd(I2C_CLK, ENABLE);    // I2C clock
    RCC_AHBPeriphClockCmd(I2C_GPIO_CLK, ENABLE);   // Peripheral clock
    // Init GPIO - SCL & SDA
	  ...
	  GPIO_PinAFConfig(I2C_SCL_PORT,I2C_SCL_PIN_SOURCE,I2C_AF_MAP);
	  ...
	  GPIO_PinAFConfig(I2C_SDA_PORT,I2C_SDA_PIN_SOURCE,I2C_AF_MAP);
