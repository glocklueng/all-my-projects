...
#define IDD_MEASURE             GPIO_Pin_4
 ...
 #define P_GATE1_GPIO_PORT 				GPIOD
 #define P_GATE1_GPIO_PIN 				GPIO_Pin_2
 #define P_GATE1_GPIO_PORT_CLK             RCC_AHBPeriph_GPIOD

 #define P_GATE2_GPIO_PORT 				GPIOC
 #define P_GATE2_GPIO_PIN 			GPIO_Pin_12
 #define P_GATE2_GPIO_PORT_CLK             RCC_AHBPeriph_GPIOC

 // n-channel MOSFET Gates
 #define N_GATE1_GPIO_PORT 				GPIOA
 #define N_GATE1_GPIO_PIN 			GPIO_Pin_12
 #define N_GATE1_GPIO_PORT_CLK             RCC_AHBPeriph_GPIOA
